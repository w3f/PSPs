...
- [1. JSON-RPC Interfaces for Polkadot Nodes](#1-json-rpc-interfaces-for-polkadot-nodes)
  ...
  - [1.5. System](#15-system)
    ...
    - [system_chainType](#system_chaintype)
    ...
    - [system_localPeerId](#system_localpeerid)
      - [Parameter](#parameter)
      - [Response](#response-1)
      - [Example](#example-1)
    - [system_localListenAddresses](#system_locallistenaddresses)
    ...
    - [system_syncState](#system_syncstate)
  ...
  - [1.11. State](#111-state)
    ...
    - [state_getReadProof](#state_getreadproof)
  ...
  - [Sync](#sync)
    - [sync_state_genSyncSpec](#sync_state_gensyncspec)
