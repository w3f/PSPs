...
Subscription for all block headers.
...
Unsubscribe the given Subscriber ID from [block header subscription](#chain_subscribeAllHeads-pubsub).
...
```bash
// Request
{"id":1, "jsonrpc":"2.0", "method": "chain_unsubscribeAllHeads", "params":[21]}
