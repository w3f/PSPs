...
Each namespace specifies RPC error code ranges of possible error types that can be returned. Known/Defined error types are listed in this document and certain APIs may return undefined error messages. The list of defined error messages are subject to expansion and changes.
...
RPC codes of returned errors are in the `2000` - `2999` range. No known error types are specified.
...
RPC codes of returned errors are in the `1000` - `1999` range. The following known error types are possible:
...
RPC codes of returned errors are in the `3000` - `3999` range. No known error types are specified.
...
RPC codes of returned errors are in the `5000` - `5999` range. No known error types are specified.
...
RPC codes of returned errors are in the `4000` - `4999` range. No known error types are specified.
